...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtreewidgetitem.setText(5, QCoreApplication.translate("MainWindow", u"Description", None));
        ___qtreewidgetitem.setText(4, QCoreApplication.translate("MainWindow", u"Show", None));
        ___qtreewidgetitem.setText(3, QCoreApplication.translate("MainWindow", u"End Date", None));
